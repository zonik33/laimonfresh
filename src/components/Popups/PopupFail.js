...
import fail from "../../image/img_33.png";
    ...
    return (
        ...
        >
            <form action={'https://nloto-promo.ru/backend/api/login'}
                ...
                <img className={'bottle-float-left fail-image'} onClick={closeModal} src={fail}/>
                <div><span className={'register-main-text top-margin fail-red'}>что-то пошло не так</span>
